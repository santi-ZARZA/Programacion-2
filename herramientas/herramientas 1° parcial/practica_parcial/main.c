    ...
    do
    {
        ...
        switch(opcion)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                bajausuario(usuarios,productos);
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            case 6:
                cancelarPublicaxion(usuarios,productos);
                break;
            case 7:
                comprarProducto(usuarios,productos);
                break;
            case 8:
                publicacionesUsuario(usuarios,productos);
                break;
            case 9:
                mostrarPublicaciones(usuarios,productos);
                break;
            case 10:
